...
describe('Root View Model', function() {
	...
	describe('Global Import', function() {
		it('should import a given json file.', function(){
			var v = new RootViewModel();
			v.importValues(data);
			v.characterTabViewModel().profileViewModel().playerName().should.equal(data.characterTabViewModel.profileViewModel.playerName);
			v.characterTabViewModel().profileViewModel().characterName().should.equal(data.characterTabViewModel.profileViewModel.characterName);
	...
	describe('Global Export', function() {	
		it('should export a given json file.', function(){
			...
			r.characterTabViewModel.profileViewModel.playerName.should.equal(data.characterTabViewModel.profileViewModel.playerName);
			r.characterTabViewModel.profileViewModel.characterName.should.equal(data.characterTabViewModel.profileViewModel.characterName);
